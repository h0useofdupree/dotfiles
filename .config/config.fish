...
# TODO: Only works with wifi interfaces for now. Change that!
set IF (nmcli connection show | grep "wlp" | awk '{print $4}')
set NW (nmcli connection show | grep "wlp" | awk '{print $1}')
set UUID (nmcli connection show | grep "wlp" | awk '{print $2}')
set TYPE (nmcli connection show | grep "wlp" | awk '{print $3}')
set MIN 60
set HOUR 3600
set HALFHOUR 1800
